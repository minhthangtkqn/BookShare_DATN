	...
	<html:form action="/sua-bai-dang.do" method="post"
		...
		<div class="row form-group">
			...
			<div>
				...
				<img src="${linkAnh1}" style="width: 130px; height: 200px;"> <input
					name="linkAnh1" value="${linkAnh1}" style="display: none;">
			</div>
			<div class="col-lg-3">
		...
		<div class="row form-group">
			...
			<div>
				...
				<img src="${linkAnh2}" style="width: 130px; height: 200px;"> <input
					name="linkAnh2" value="${linkAnh2}" style="display: none;">
			</div>
			<div class="col-lg-3">
		...
		<div class="row form-group">
			...
			<div>
				...
				<img src="${linkAnh3}" style="width: 130px; height: 200px;"> <input
					name="linkAnh3" value="${linkAnh3}" style="display: none;">
			</div>
			<div class="col-lg-3">
		...
		<div class="row form-group">
			...
			<div>
				...
				<img src="${linkAnh4}" style="width: 130px; height: 200px;"> <input
		...
		<div class="row form-group">
			...
			<div>
				...
				<img src="${linkAnh5}" style="width: 130px; height: 200px;"> <input
