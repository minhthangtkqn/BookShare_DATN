...
<!--                                 <li><a href="#"><i class="fa fa-phone"></i> +8499999999</a></li> -->
<!--                                 <li><a href="#"><i class="fa fa-envelope"></i> info@linebook.com</a></li> -->
<!--                             </ul> -->
<!--                         </div> -->
<!--                     </div> -->
<!--                     <div class="col-sm-6"> -->
...
<!--                             <a href="index.html"><img src="images/home/logobook.png" alt="" style="height: 100%; width: 100%" /></a> -->
<!--                         </div> -->
<!--                     </div> -->
...
<!--  									</select> -->
<!--                                 <input style="width: 92%" type="search" name="query" value="" placeholder="Từ khóa tìm kiếm... " class="input-group-field st-default-search-input search-text" autocomplete="off"> -->
