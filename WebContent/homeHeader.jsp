...
<!--                            <input type="text" id="bookname" name="bookname" /> <a href="#"><i-->
<!--								class="glyphicon glyphicon-search"></i></a>-->
                    ...
                    <div class="col-sm-3" style="margin-top: 15px;">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <li><div style="height: 40px;"><a href="trang-ca-nhan.do"><img class="img-circle" style="height: 40px; width: 40px;" alt="" src="${Avatar}">  ${userName} </a></div></li>
                                <li><div style="height: 40px; padding-top: 7px;"><a href="dang-xuat.do"><i class="glyphicon glyphicon-off"></i> Đăng xuất</a></div></li>
                            </ul>
                        </div>
                    </div>
                </div>
