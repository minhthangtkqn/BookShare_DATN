...
//	}
	...
	// return "RaoBan [anhNguoiBan=" + anhNguoiBan + ", dienThoaiNguoiBan="
	// + dienThoaiNguoiBan + ", emailNguoiBan=" + emailNguoiBan
	// + ", ghiChuRaoBan=" + ghiChuRaoBan + ", gia=" + gia
	// + ", gioiTinh=" + gioiTinh + ", hoTenNguoiBan=" + hoTenNguoiBan
	// + ", linkAnh1=" + linkAnh1 + ", linkAnh2=" + linkAnh2
	// + ", linkAnh3=" + linkAnh3 + ", linkAnh4=" + linkAnh4
	// + ", linkAnh5=" + linkAnh5 + ", maDanhMuc=" + maDanhMuc
	// + ", maNguoiRaoBan=" + maNguoiRaoBan + ", maRaoBan=" + maRaoBan
	// + ", maTinhBan=" + maTinhBan
	// + ", maTinhNguoiBan=" + maTinhNguoiBan + ", moTa=" + moTa
	// + ", namSinhNguoiBan=" + namSinhNguoiBan + ", namxb=" + namxb
	// + ", ngayBan=" + ngayBan + ", ngayDuocBan=" + ngayDuocBan
	// + ", nxb=" + nxb + ", tacGia=" + tacGia + ", taiKhoanNguoiBan="
	// + taiKhoanNguoiBan + ", tenDanhMuc=" + tenDanhMuc
	// + ", tenSach=" + tenSach + ", tenTinhBan=" + tenTinhBan
	// + ", tenTinhNguoiBan=" + tenTinhNguoiBan + ", trangThaiRaoBan="
	// + trangThaiRaoBan + "]";
	// }
